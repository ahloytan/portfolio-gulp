class Bio extends React.Component {
  ...
  render() {
    ...
    var bioDir = "app/images_doc/whatILove/";
    ...
    var doLoop = categories.map((d, i) => {
      return <div key={d} className="bioBox">
        <div className="catHolder style_prevu_kit">
          ...
          <img className={d} src={bioDir + d + ".svg"} title={this.props.title}/>
          </a>
        </div>
        <div className="top2">
    ...
    <div className="description"> Current SMU Information Systems undergraduate. 24 years old. I took these background images! Love me some sports, piano & games. Grateful to be featured on <a href={this.state.vidLink} target="_blank">MINDEF</a>!</div>
